...
static string folderName = "mnist6k";

const static string relativePath = "E:/1hiddenlayer/";								//CHANGE !
...
const int trainingDataSamplesCounter = 6000;
...
static double* weightstHiddenOutput[hiddenNeuronNumber + 1], * hiddenLayerIn, * hiddenLayerOUT;
